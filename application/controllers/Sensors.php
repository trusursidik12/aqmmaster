	...
	public function index(){
		...
		if($aqm_data_ranges != 0){
			...
			$aqm_data_values = ["id_stasiun" => $this->sensors_m->get_id_stasiun(),
								"waktu" => $values->now,
								"pm10" => round($tot_pm10/$num_data,3),
								"pm25" => round($tot_pm25/$num_data,3),
								"so2" => round($tot_so2/$num_data,3),
								"co" => round($tot_co/$num_data,3),
								"o3" => round($tot_o3/$num_data,3),
								"no2" => round($tot_no2/$num_data,3),
								"hc" => round($tot_hc/$num_data,3),
								"voc" => round($tot_voc/$num_data,3),
								"h2s" => round($tot_h2s/$num_data,3),
								"cs2" => round($tot_cs2/$num_data,3),
								"ws" => $data["WindSpeed"],
								"wd" => $data["WindDir"],
