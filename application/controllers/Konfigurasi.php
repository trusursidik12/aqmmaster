...
class Konfigurasi extends CI_Controller
{
	...
	public function index()
	{
		...
		$data['configurations'][3]['id'] = "sampler_operator_name";
		$data['configurations'][3]['caption'] = "Sampler Operator Name";
		$data['configurations'][3]['value'] = $this->konfigurasi_m->getConfigurationContent('sampler_operator_name');
		$data['configurations'][4]['id'] = "sta_alamat";
		$data['configurations'][4]['caption'] = "Alamat";
		$data['configurations'][4]['value'] = $this->konfigurasi_m->getConfigurationContent('sta_alamat');
		$data['configurations'][5]['id'] = "sta_kota";
		$data['configurations'][5]['caption'] = "Kota";
		$data['configurations'][5]['value'] = $this->konfigurasi_m->getConfigurationContent('sta_kota');
		$data['configurations'][6]['id'] = "sta_prov";
		$data['configurations'][6]['caption'] = "Propinsi";
		$data['configurations'][6]['value'] = $this->konfigurasi_m->getConfigurationContent('sta_prov');
		$data['configurations'][7]['id'] = "sta_lat";
		$data['configurations'][7]['caption'] = "Latitude";
		$data['configurations'][7]['value'] = $this->konfigurasi_m->getConfigurationContent('sta_lat');
		$data['configurations'][8]['id'] = "sta_lon";
		$data['configurations'][8]['caption'] = "Longitude";
		$data['configurations'][8]['value'] = $this->konfigurasi_m->getConfigurationContent('sta_lon');
		$data['configurations'][9]['id'] = "altitude";
		$data['configurations'][9]['caption'] = "Altitude";
		$data['configurations'][9]['value'] = $this->konfigurasi_m->getConfigurationContent('altitude');
		$data['configurations'][10]['id'] = "pump_interval";
		$data['configurations'][10]['caption'] = "Interval Pompa (menit)";
		$data['configurations'][10]['value'] = $this->konfigurasi_m->getConfigurationContent('pump_interval');
		$data['configurations'][11]['id'] = "pump_control";
		$data['configurations'][11]['caption'] = "Kontroler Pompa (1=Show ; 0=Hide)";
		$data['configurations'][11]['value'] = $this->konfigurasi_m->getConfigurationContent('pump_control');
		$data['configurations'][12]['id'] = "is_sampling";
		$data['configurations'][12]['caption'] = "Fitur Sampling (1=Show ; 0=Hide)";
		$data['configurations'][12]['value'] = $this->konfigurasi_m->getConfigurationContent('is_sampling');
		$data['configurations'][13]['id'] = "data_interval";
		$data['configurations'][13]['caption'] = "Collect Data Interval (Menit)";
		$data['configurations'][13]['value'] = $this->konfigurasi_m->getConfigurationContent('data_interval');
		$data['configurations'][14]['id'] = "graph_interval";
		$data['configurations'][14]['caption'] = "Graph Refresh Interval (Menit) (0 => setiap detik)";
		$data['configurations'][14]['value'] = $this->konfigurasi_m->getConfigurationContent('graph_interval');

		$data['configurations'][15]['caption'] = "Labjack AIN's";
		$data['configurations'][15]['value'] = $this->konfigurasi_m->getConfigurationContent('param_labjack');
		$data['configurations'][15]['id'] = "param_labjack";

		$data['configurations'][16]['caption'] = "Labjack Force On (0 => No, 1 => Yes)";
		$data['configurations'][16]['value'] = $this->konfigurasi_m->getConfigurationContent('labjack_force_on');
		$data['configurations'][16]['id'] = "labjack_force_on";
		$data['configurations'][17]['caption'] = "Calibration Menu (0 => No, 1 => Yes)";
		$data['configurations'][17]['value'] = $this->konfigurasi_m->getConfigurationContent('calibration_menu');
		$data['configurations'][17]['id'] = "calibration_menu";
