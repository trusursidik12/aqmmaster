...
<body onload="startTime()">
		...
		<div class="collapse navbar-collapse" id="navbarText">
			<ul class="navbar-nav mr-auto">
				...
				<?php if ($calibration_menu == 1) : ?>
					<li class="nav-item <?= strpos(" " . $this->uri->uri_string(), 'kalibrasi') ? 'active' : ''; ?>">
			...
			<div id="online_indicator">
				<h6 style='color:#FF0000;'>Internet Disconnect</h6>
			</div>&nbsp;&nbsp;&nbsp;&nbsp;
	...
	<script>
		function cek_is_online() {
			$.ajax({
				url: "https://ispumaps.id/server_side/api/is_connect.php",
