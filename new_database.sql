...
('so2', 'SO2', 'ppm',64.06,'round((125 * $AIN0 - 5) * $factor[''aso2''] - $factor[''bso2''], 3)', 1, '2020-02-19 06:44:38'),
('co', 'CO', 'ppm',28.01,'round((1250.0 * $AIN1 - 50.0) * $factor[''aco''] + $factor[''bco''], 3)', 1, '2020-02-19 06:44:38'),
('o3', 'O3', 'ppm',48,'round((625.0 * $AIN2 - 25.0) * $factor[''ao3''] + $factor[''bo3''], 3)', 1, '2020-02-19 06:44:38'),
('no2', 'NO2', 'ppm',46.01,'round((125.0 * $AIN3 - 5.0) * $factor[''ano2''] + $factor[''bno2''], 3)', 1, '2020-02-19 06:44:38'),
('voc', 'VOC', 'ppm',78.9516,'0', 1, '2020-02-19 06:44:38'),
('h2s', 'H2S', 'ppm',34.08,'round(3.2 * ((8 + $factor[''ah2s'']) * $AIN0) - $factor[''bh2s''], 3)', 1, '2020-02-19 06:44:38'),
('hc', 'HC', 'ppm',13.0186,'round((364002231.0 * pow($AIN1, 4.0) - 108931228.4 * pow($AIN1, 3.0) + 11924488.64 * pow($AIN1, 2.0) - 574919.2456 * $AIN1 + 10778.05204) * $factor[''ahc''] + $factor[''bhc''], 3)', 1, '2020-02-19 06:44:38'),
('cs2', 'CS2', 'ppm',76.1407,'round(1.2 * ((24 + $factor[''acs2'']) * $AIN2) - $factor[''bcs2''], 3)', 1, '2020-02-19 06:44:38'),
